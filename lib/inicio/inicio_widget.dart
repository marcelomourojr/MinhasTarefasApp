      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(25.0, 65.0, 25.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                        ...
                        children: [
                          StreamBuilder<List<TarefasRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<TarefasRecord> listView1TarefasRecordList =
                                  snapshot.data!;
                              ...
                              return ListView.builder(
                                ...
                                itemCount: listView1TarefasRecordList.length,
                                itemBuilder: (context, listView1Index) {
                                  final listView1TarefasRecord =
                                      listView1TarefasRecordList[
                                          listView1Index];
                                  return Padding(
                        ...
                        children: [
                          StreamBuilder<List<TarefasRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<TarefasRecord> listView2TarefasRecordList =
                                  snapshot.data!;
                              ...
                              return ListView.builder(
                                ...
                                shrinkWrap: true,
                                scrollDirection: Axis.vertical,
                                itemCount: listView2TarefasRecordList.length,
                                itemBuilder: (context, listView2Index) {
                                  final listView2TarefasRecord =
                                      listView2TarefasRecordList[
                                          listView2Index];
                                  return Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 15.0),
